...
public class TeacherView {
	...
	public String getUser(int id) throws SQLException {
		...
		String url = "jdbc:mysql://mysql-vikas-2006.alwaysdata.net/vikas-2006_attendance";
		Properties info = new Properties();
		info.setProperty("user", "384720");
		info.setProperty("password", "vikas@2006");

		Connection con = DriverManager.getConnection(url, info);
		String str = "SELECT name FROM teachers WHERE id = " + id;
		System.out.println("teacher login" + id + " " + str);
